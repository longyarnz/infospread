...
App.get('/populate', function (req, res) {
  return res.json((0, _data2.default)());
});
...
App.post('/graphql', _bodyParser2.default.json({ extended: true }), _parseQuery2.default, (0, _expressGraphql2.default)({ schema: schema, rootValue: rootValue, pretty: true }));
