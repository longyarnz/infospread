...
exports.default = {
  ...
  Mutation: {
    AddTags: function AddTags(_ref18, _ref19) {
      var Palette = _ref18.Palette;
      var tags = _ref19.tags;
      return Palette.addTags(tags);
    },
    RemoveTags: function RemoveTags(_ref20, _ref21) {
      var Palette = _ref20.Palette;
      var tags = _ref21.tags;
      return Palette.removeTags(tags);
    },
    AddInterests: function AddInterests(_ref22, _ref23) {
      var Viewer = _ref22.Viewer;
      var interests = _ref23.interests;
      return Viewer.addInterests(interests);
    },
    RemoveInterests: function RemoveInterests(_ref24, _ref25) {
      var Viewer = _ref24.Viewer;
      var interests = _ref25.interests;
      return Viewer.removeInterests(interests);
    },
    CreatePalette: function CreatePalette(_ref26, _ref27) {
      var Palette = _ref26.Palette;
      var palettes = _ref27.palettes;
      return Palette.set(palettes);
    },
    CreatePlatform: function CreatePlatform(_ref28, _ref29) {
      var Platform = _ref28.Platform;
      var platforms = _ref29.platforms;
      return Platform.set(platforms);
    },
    CreateCustomer: function CreateCustomer(_ref30, _ref31) {
      var Customer = _ref30.Customer;
      var users = _ref31.users;
      return Customer.set(users);
    },
    CreateViewer: function CreateViewer(_ref32, _ref33) {
      var Viewer = _ref32.Viewer;
      var viewers = _ref33.viewers;
      return Viewer.set(viewers);
    },
    UpdatePalette: function UpdatePalette(_ref34, _ref35) {
      var Palette = _ref34.Palette;
      var palette = _ref35.palette;
      return performUpdate(Palette, palette);
    },
    UpdatePlatform: function UpdatePlatform(_ref36, _ref37) {
      var Platform = _ref36.Platform;
      var platform = _ref37.platform;
      return performUpdate(Platform, platform);
    },
    UpdateCustomer: function UpdateCustomer(_ref38, _ref39) {
      var Customer = _ref38.Customer;
      var user = _ref39.user;
      return performUpdate(Customer, user);
    },
    UpdateViewer: function UpdateViewer(_ref40, _ref41) {
      var Viewer = _ref40.Viewer;
      var viewer = _ref41.viewer;
      return performUpdate(Viewer, viewer);
    },
    RemoveEntries: function () {
      var _ref44 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(_ref42, _ref43) {
        var Palette = _ref42.Palette,
            Customer = _ref42.Customer,
            Viewer = _ref42.Viewer,
            Platform = _ref42.Platform;
        var options = _ref43.options;
