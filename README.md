...
### Server Response
The response of the server to a valid query is a JSON object containing a field named **data**. It must be parsed to an object format before use. In the case of an error, the **data** field is **null** and an **error** field is gotten instead giving information about the error.  
